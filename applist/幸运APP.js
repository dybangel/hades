...
function finditem(){
         var main=className("android.support.v7.widget.RecyclerView").findOnce(0)//.childCount();
          ...
          for(var i=0;i<main.childCount();i++){
           ...
           ggk = main.child(i).child(0).child(5).text();
            if("刮刮卡"==ggk ){
...
function swipeguagua(){
  var result=id("com.wangniu.lucky:id/scratch_card_grid").exists();
  if(result){
    var thisleft=id("com.wangniu.lucky:id/scratch_card_grid").findOnce().bounds().left;
    var thistop=id("com.wangniu.lucky:id/scratch_card_grid").findOnce().bounds().top;
    var thisright=id("com.wangniu.lucky:id/scratch_card_grid").findOnce().bounds().right;
    var thisbottom=id("com.wangniu.lucky:id/scratch_card_grid").findOnce().bounds().bottom;
  ...
  //  var sx6=sx5+sx4;
   ...
   sleep(800)
   Swipe(160,2223,1271,2383,800);
   sleep(800)
   Swipe(160,2376,1240,2258,800);
  }
  sleep(5000);
 thisforstart=false;
}  
