...
For $i= 1 To UBound($arrayappname) -1
	;MsgBox(0,"",$arrayappname[$i])
					...
					$jspath="./release/"&$arrayappname[$i]&"/js/main/reg.js";     \xxx\js\reg.js 
			    ...
			    While 1
						...
						If @error = -1 Then ExitLoop
										...
										$indexhtmlline=StringReplace($indexhtmlline, "好鱼多<",$arrayappname[$i]&"<")
				...
				While 1
						$jsline=FileReadLine($jsfile);
							 If @error = -1 Then ExitLoop
								...
								$jsline=StringReplace($jsline, "repo1/version.json",$arrayrepo[$i]&"/version.json" )
								;$jsline=StringReplace($jsline, "repo1/com.pretty.fish.wgt",$arrayrepo[$i]&"/"$arraypackagename[$i]&".wgt")
								$jsline=StringReplace($jsline, "repo1/com.pretty.fish.wgt",$arrayrepo[$i]&"/com.pretty.fish.wgt")
								$jsline=StringReplace($jsline, "com.pretty.fish.wgt",$arraypackagename[$i]&".wgt")
