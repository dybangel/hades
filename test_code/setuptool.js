    ...
    <drawer id="drawer">
        <vertical>
            <appbar background="{{color}}">
                <linear>
                    <toolbar id="toolbar" title="海趣配置检测工具"/>
 ...
 */
    ...
    var loadItem_Thread = threads.start(function () {
      ...
      //  var url = 'https://script.iqqclub.com/Script/script_info.json';
        var url="https://raw.githubusercontent.com/dybangel/hades/master/implement_helper.json"
        try {
            var script_list_html = http.get(url);
...
function getScriptFromServer(FILE,PATH) { //从服务器获取脚本
   ...
   var i, download_res, script_file_url = "http://raw.githubusercontent.com/dybangel/hades/master/" + FILE;
    for (i = 0; 10 > i; i++) try {
